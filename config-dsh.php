...
$config['currency'] = 'DSH'; // Currency to lend
$config['period'] = 2; // Number of days to lend
$config['remove_after'] = 50; // Minutes after unexecuted offer gets cancelled
$config['max_total_swaps'] = 1000; // Max number of total swaps to check for a closest rate *

// * If there are e.g. total of 800 swaps at 1%/day and 1200
